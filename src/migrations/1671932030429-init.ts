...
export class init1671932030429 implements MigrationInterface {
    name = 'init1671932030429'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "stream" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "game" varchar NOT NULL, "messageId" integer NOT NULL, "channelId" varchar NOT NULL, CONSTRAINT "REL_3f6374a1c1282a0d3624361dec" UNIQUE ("channelId"))`);
        await queryRunner.query(`CREATE TABLE "channel" ("id" varchar PRIMARY KEY NOT NULL, "topicId" integer NOT NULL)`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_stream"("id", "title", "game", "messageId", "channelId") SELECT "id", "title", "game", "messageId", "channelId" FROM "stream"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "stream" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "game" varchar NOT NULL, "messageId" integer NOT NULL, "channelId" varchar NOT NULL, CONSTRAINT "REL_3f6374a1c1282a0d3624361dec" UNIQUE ("channelId"))`);
        await queryRunner.query(`INSERT INTO "stream"("id", "title", "game", "messageId", "channelId") SELECT "id", "title", "game", "messageId", "channelId" FROM "temporary_stream"`);
